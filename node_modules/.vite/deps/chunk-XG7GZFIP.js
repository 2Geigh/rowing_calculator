...
function pie(_temp4) {
  ...
  if (sort === null) path2.sort(sort);
  else if (sort != null) path2.sort(sort);
...
function AreaClosed(_ref) {
  ...
  if (y2 && !y1) setNumberOrNumberAccessor(path2.y1, y2);
  if (y1 && !y2) setNumberOrNumberAccessor(path2.y1, y1);
...
//# sourceMappingURL=chunk-XG7GZFIP.js.map
